...
{
    public partial class FrmC2Pregunta4 : Form
    {
        public FrmC2Pregunta4()
        {
            InitializeComponent();
        }
        public int counter = 0;
        public int recibirClikFor3;
        public int recibirClickFor4DeFor2;
        public int recibirClickFor4DeFor3;
        ...
        private void FrmC2Pregunta4_Load(object sender, EventArgs e)
        {
            BlquearBtn50a50();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            if (rdbRespuesta4.Checked == true)
            {
                MessageBox.Show("Usted Se lleva a su casa $2.00");
                this.Dispose();
                Usuario1 usu = new Usuario1();
                usu.Show();
            }
        ...
        {
            FrmC2Pregunta5 avanzar = new FrmC2Pregunta5();
            avanzar.recibirClickFor5DeFor4 = counter;
            avanzar.recibirClikFor3 = recibirClikFor3;
            avanzar.recibirClickFor5DeFor2 = recibirClickFor4DeFor2;
            avanzar.recibirClickFor5DeFor3 = recibirClickFor4DeFor3;
